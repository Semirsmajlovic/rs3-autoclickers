...
def click_loop():
    ...
    smart_wait(random.uniform(3, 8), "first dung hole click")
    ...
    while running:
        try:
            ...
            if dung_hole_count % settings['cocktail_interval'] == 0:
                ...
                smart_wait(random.uniform(3, 8), "next dung hole click")
...
def main():
    ...
    logger.info("💡 Tip: Set SHOW_DETAILED_PROGRESS=True at top of script for more frequent updates")
